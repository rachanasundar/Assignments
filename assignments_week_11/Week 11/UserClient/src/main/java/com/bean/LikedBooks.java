...
public class LikedBooks {
	...
	public LikedBooks(CompositeKey key, String bookName, String author, String bookGenre, String bookImageUrl,
	...
	public String toString() {
		return "LikedBooks [key=" + key + ", bookName=" + bookName + ", author=" + author + ", bookGenre=" + bookGenre
