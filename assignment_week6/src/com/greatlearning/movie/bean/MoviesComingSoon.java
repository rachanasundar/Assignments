...
public class MoviesComingSoon implements Movies {
	private int id;
...
//to avoid creation of object through class
	private MoviesComingSoon() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	//to return the instance of the class
	private static MoviesComingSoon movie = new MoviesComingSoon();
	public static  MoviesComingSoon getInstance() {
		return movie;
	}
	...
	public String toString() {
		return "MoviesComingSoon [id=" + id + ", title=" + title + ", year=" + year + ", genres="
